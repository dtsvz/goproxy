...
[![GoDoc](https://godoc.org/github.com/dtsvz/goproxy?status.svg)](https://godoc.org/github.com/dtsvz/goproxy)
[![Join the chat at https://gitter.im/dtsvz/goproxy](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/dtsvz/goproxy?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
...
Get the latest goproxy from `gopkg.in/dtsvz/goproxy.v1`.
...
[the eavesdropper example](https://github.com/dtsvz/goproxy/blob/master/examples/goproxy-eavesdropper/main.go#L27)
2. Transparent proxy support for http/https including MITM certificate generation for TLS.  See the [transparent example.](https://github.com/dtsvz/goproxy/tree/master/examples/goproxy-transparent)
